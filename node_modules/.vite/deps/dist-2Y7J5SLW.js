...
import {
  ...
  toSmartAccount,
  y
} from "./chunk-XAIAORGQ.js";
import {
  ens_normalize
} from "./chunk-VKEEO2RO.js";
import {
  wordlist,
  wordlist10,
  wordlist2,
  ...
  wordlist8,
  wordlist9
} from "./chunk-5L6YJNV7.js";
import {
  createStore,
  del,
  get,
  set
} from "./chunk-AACRRZKY.js";
import "./chunk-MN5E3CR4.js";
import "./chunk-X7Z5THTS.js";
import {
  createPublicClient,
  http,
  parseSignature,
  waitForCallsStatus
} from "./chunk-5MQ7W4YA.js";
import {
  HDKey,
  defineChain,
  encodePacked,
  ...
  readContract,
  validateMnemonic
} from "./chunk-4AVX5GTW.js";
import "./chunk-4ZMJIFPJ.js";
import {
  BaseError,
  decodeAbiParameters,
  decodeFunctionData,
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/abstract/utils.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/secp256k1.js
var import_dist265 = __toESM(require_dist());
var import_dist266 = __toESM(require_dist2());
var import_dist267 = __toESM(require_dist3());

// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/_shortw_utils.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/hashes/esm/hmac.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/abstract/weierstrass.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/abstract/curve.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/abstract/modular.js
...
function weierstrassPoints(opts) {
  ...
  class Point2 {
    ...
    multiplyUnsafe(sc) {
      ...
      if (k2neg)
        k2p = k2p.negate();
      k2p = new Point2(Fp3.mul(k2p.px, endo2.beta), k2p.py, k2p.pz);
      return k1p.add(k2p);
    }
    /**
...
function weierstrass(curveDef) {
  ...
  class Signature {
    ...
    recoverPublicKey(msgHash) {
      ...
      const R = Point2.fromHex(prefix + numToSizedHex(radj, Fp3.BYTES));
      const ir = invN(radj);
  ...
  function prepSig(msgHash, privateKey, opts = defaultSigOpts) {
    ...
    const { hash: hash8, randomBytes: randomBytes2 } = CURVE;
...
function createCurve(curveDef, defHash) {
  const create4 = (hash8) => weierstrass({ ...curveDef, ...getHash(hash8) });
  return { ...create4(defHash), create: create4 };
}

// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/abstract/hash-to-curve.js
...
function hash_to_field(msg, count, options) {
  ...
  const { p, k, m, hash: hash8, expand, DST: _DST } = options;
  abytes2(msg);
  anum(count);
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/bls12-381.js
var import_dist322 = __toESM(require_dist());
var import_dist323 = __toESM(require_dist2());
var import_dist324 = __toESM(require_dist3());

// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/abstract/bls.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/abstract/tower.js
    ...
    toBytes: (c, point, isCompressed) => {
      ...
      if (isCompressed) {
        ...
        if (isZero) {
          ...
          return concatBytes2(numberToBytesBE(x, Fp.BYTES), numberToBytesBE(y2, Fp.BYTES));
        }
      }
    },
    ShortSignature: {
  ...
  G2: {
    ...
    Signature: {
      ...
      fromHex(hex) {
        ...
        const isZero = y1 === _0n9 && y0 * _2n7 / P !== aflag1;
        if (isGreater || isZero)
          y3 = Fp2.neg(y3);
...
// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/p256.js
var import_dist394 = __toESM(require_dist());
var import_dist395 = __toESM(require_dist2());
var import_dist396 = __toESM(require_dist3());

// node_modules/@coinbase/wallet-sdk/node_modules/ox/node_modules/@noble/curves/esm/nist.js
...
function randomPrivateKey3(options = {}) {
  const { as = "Hex" } = options;
  const bytes2 = secp256r12.utils.randomPrivateKey();
  if (as === "Hex")
    return fromBytes(bytes2);
  return bytes2;
}
function recoverPublicKey2(options) {
  const { payload, signature } = options;
  const { r: r2, s, yParity } = signature;
  const signature_ = new secp256r12.Signature(BigInt(r2), BigInt(s)).addRecoveryBit(yParity);
...
function sign3(options) {
  const { extraEntropy: extraEntropy2 = extraEntropy, hash: hash8, payload, privateKey } = options;
  const { r: r2, s, recovery } = secp256r12.sign(payload instanceof Uint8Array ? payload : fromHex(payload), privateKey instanceof Uint8Array ? privateKey : fromHex(privateKey), {
    extraEntropy: typeof extraEntropy2 === "boolean" ? extraEntropy2 : from2(extraEntropy2).slice(2),
    lowS: true,
    ...hash8 ? { prehash: true } : {}
  });
...
function verify3(options) {
  ...
  return secp256r12.verify(signature, payload instanceof Uint8Array ? payload : fromHex(payload), toHex3(publicKey).substring(2), ...hash8 ? [{ prehash: true, lowS: true }] : []);
}
...
var WalletLinkSession = class _WalletLinkSession {
  constructor(storage3, id, secret, linked = false) {
    ...
    this.id = id;
    this.secret = secret;
    this.key = bytesToHex2(sha2564(`${id}, ${secret} WalletLink`));
    this._linked = !!linked;
  }
...
*/
//# sourceMappingURL=dist-2Y7J5SLW.js.map
