...
} from "./chunk-N5ECO4KR.js";
import {
  require_browser
} from "./chunk-HNK5TCMB.js";
import {
  RpcSchema_exports,
  call_exports,
  mini_exports
} from "./chunk-DZ3PQ6JO.js";
import {
  arbitrum,
  arbitrumSepolia,
  base,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-YKRVILTP.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-2Y7J5SLW.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-S55OJ7TL.js");
...
// node_modules/@metamask/utils/dist/hashing.mjs
...
// node_modules/@metamask/utils/dist/mnemonic.mjs
...
var englishWordlist = __toESM(require_english(), 1);
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-NDFTJAII.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
...
// node_modules/porto/dist/internal/index.js
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-DXL7OLDV.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-Z2UBQ4MF.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-PWHQMWG7.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-V5P6C5UR.js");
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7E6QIJY4.js.map
