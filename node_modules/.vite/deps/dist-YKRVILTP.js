...
function weierstrassPoints(opts) {
  ...
  class Point2 {
    ...
    toRawBytes(isCompressed = true) {
      ...
      this.assertValidity();
      return toBytes10(Point2, this, isCompressed);
    }
...
function weierstrass(curveDef) {
  ...
  const slcNum = (b2, from29, to3) => bytesToNumberBE(b2.slice(from29, to3));
  class Signature {
...
var getHash2 = withTelemetry(getHashFn);
...
var requestSpendPermissionFn = async (request) => {
  ...
  const [signature, permissionHash] = await Promise.all([
    ...
    getHash2({ permission: typedData.message, chainId })
  ]);
  const permission = {
...
async function subscribe(options) {
  ...
  try {
    ...
    try {
      ...
      const permissionHash = await getHash2({
        permission: message,
        chainId
      });
      if (telemetry) {
...
*/
//# sourceMappingURL=dist-YKRVILTP.js.map
